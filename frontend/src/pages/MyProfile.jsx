  ...
  return (
    <Container maxWidth="sm" sx={{ mt: 5 }}>
      ...
      <form onSubmit={handleSubmit}>
        <TextField fullWidth label="Full Name" name="name" value={name} onChange={handleChange} margin="normal" required />
        <TextField fullWidth label="Email" name="email" type="email" value={email} onChange={handleChange} margin="normal" required />
        <TextField fullWidth label="New Password" name="password" type="password" value={password} onChange={handleChange} margin="normal" helperText="Leave blank if you don't want to change your password" />
        <TextField fullWidth label="Date of Birth" name="dob" type="date" value={dob || ""} onChange={handleChange} margin="normal" InputLabelProps={{ shrink: true }} />
        <TextField select fullWidth label="Sex" name="sex" value={sex} onChange={handleChange} margin="normal">
          <MenuItem value="">Select</MenuItem>
          <MenuItem value="Male">Male</MenuItem>
          <MenuItem value="Female">Female</MenuItem>
          <MenuItem value="Other">Other</MenuItem>
        </TextField>
        <TextField fullWidth label="Location" name="location" value={location} onChange={handleChange} margin="normal" />
        <Box mt={3}>
          <Button type="submit" variant="contained" color="primary">Save Changes</Button>
          <Button variant="outlined" sx={{ ml: 2 }} onClick={() => navigate("/dashboard")}>Back to Dashboard</Button>
        </Box>
      </form>

      <Typography variant="h5" sx={{ mt: 4 }}>Health Problem Notes</Typography>
      <TextField label="Add Health Problem" fullWidth value={note} onChange={(e) => setNote(e.target.value)} margin="normal" />
      ...
      <List>
        {notes.map((item, index) => (
          <ListItem key={index}>
            {item}
            <Button onClick={() => deleteNote(index)} color="error" sx={{ ml: 2 }}>Delete</Button>
          </ListItem>
        ))}
      </List>
    </Container>
...
///-----------------very previous code where form was not working
